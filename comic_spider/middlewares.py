...
class ShenduddSpiderMiddleware(object):
...
class ShenduddDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class RandomProxyMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        for ip in proxies:
            ...
            urlmid = 'https://www.baidu.com'
            try:
                r = requests.get(urlmid, proxies=proxie, timeout=2)
